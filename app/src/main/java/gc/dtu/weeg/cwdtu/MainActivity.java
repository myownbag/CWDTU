...
import gc.dtu.weeg.cwdtu.bluetooth.BluetoothService;
import gc.dtu.weeg.cwdtu.bluetooth.BluetoothState;
import gc.dtu.weeg.cwdtu.bluetooth.DeviceListActivity;
import gc.dtu.weeg.cwdtu.fregment.AppVersioninfoFregment;
import gc.dtu.weeg.cwdtu.fregment.BaseFragment;
import gc.dtu.weeg.cwdtu.fregment.BasicinfoFregment;
import gc.dtu.weeg.cwdtu.fregment.CNKFixedPagerAdapter;
import gc.dtu.weeg.cwdtu.fregment.FrozendataFregment;
import gc.dtu.weeg.cwdtu.fregment.GasSensorSetFragment;
import gc.dtu.weeg.cwdtu.fregment.GateStatusControlFragment;
import gc.dtu.weeg.cwdtu.fregment.Hex2BinConvertFragment;
...
import static gc.dtu.weeg.cwdtu.bluetooth.BluetoothState.REQUEST_CONNECT_DEVICE;
import static gc.dtu.weeg.cwdtu.bluetooth.BluetoothState.REQUEST_ENABLE_BT;
